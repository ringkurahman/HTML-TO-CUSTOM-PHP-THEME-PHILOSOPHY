...
function philosophy_page_metabox( $options ){
  ...
  $page_id = 0;
    ...
    // Single Page Template Condition
    $current_page_template = get_post_meta( $page_id, '_wp_page_template', true);
    if ( 'about.php' != $current_page_template ){
      return $options;
    }
/*
    // Multiple Page template Condition
    $current_page_template = get_post_meta( $page_id, '_wp_page_template', true);
...
*/
  ...
  $options[] = array(
    ...
    'sections' => array(
      array(
        'name' => 'page-section1',
        'title' => __( 'Page Setings', 'philosophy' ),
        'icon' => 'fa fa-image',
        'fields' => array(
          array(
            'id' => 'page-heading',
            ...
            array(
                ...
                'fields' => array(
                    ...
                    array(
                        ...
                        'type'        => 'gallery',
                        'title'       => __( 'Upload Image', 'philosophy' ),
                        'add_title'   => __( 'Add Gallery Images', 'philosophy' ),
